...
CROP_SIZE = 88
UPSCALE_FACTOR = 4 # 업스케일 크기
NUM_EPOCHS = 500

train_set = TrainDatasetFromFolder('D:\train_set', crop_size=CROP_SIZE, upscale_factor=UPSCALE_FACTOR)
val_set = ValDatasetFromFolder('D:\val_set', upscale_factor=UPSCALE_FACTOR)
...
for epoch in range(1, NUM_EPOCHS + 1):
    ...
    """
    print(train_bar[0],train_bar[1])
    print(train_loader[0],train_loader[1])
    """

    netG.train()
    netD.train()
    for data, target in train_loader:  #trainbar -> trainloader
        g_update_first = True
        ...
        #train_bar.set_description(desc= -> 날리고 print로 묶기
